...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles, const CChainParams& chainparams)
{
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    int64_t nPowTargetSpacing = chainparams.GetConsensus().nPowTargetSpacing;
